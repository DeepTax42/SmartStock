...
> 4. Swagger UI로 API 확인 (`127.0.0.1:8000/docs`)  
  ...
  ## Ⅷ. 팀 구성 및 역할 (Team Members & R&R)
> SmartStock AI 프로젝트는 UI·UX, 백엔드/배포, AI 모델링 세 영역으로 나뉘며,  
> 각 팀원이 역할에 따라 프로젝트 전반을 협업하여 완성했습니다.  
> <br>

---

| **번호** | **이름** | **담당 영역** | **주요 역할 (Role)** |
|:--:|:--:|:--|:--|
...
>  **요약**
> - **이유진:** UI/UX & 프론트엔드 전반, 대시보드 및 시각화 중심  
